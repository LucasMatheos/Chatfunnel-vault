...
Skill complementar ao `AGENTS.md` (e `CLAUDE.md`) do chatfunnel-front. O AGENTS.md cobre **design system, componentes e styling**. Esta skill cobre **arquitetura, composables, stores, performance e organizacao**.
...
| Tema | Arquivo |
|------|---------|
| Design system, componentes, CVA | `chatfunnel-front/AGENTS.md` (espelho `CLAUDE.md`) |
