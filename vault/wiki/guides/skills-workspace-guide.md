...
vault/
  ...
  wiki/
    ...
    features/                       ← 10 artigos
      ...
      mcp-integration                 Servidor MCP, tokens, tools
      organization-form               Wizard de criacao de org (in-design)
      onboarding-flow                 Signup → onboarding → dashboard
    layers/ (DEPRECATED)            ← substituido por repos/
