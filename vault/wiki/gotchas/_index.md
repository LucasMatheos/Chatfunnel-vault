...
| Vue v2 components, SWC watch, core sync, chatfunnel-database, dialog aninhado, vue-i18n d(), sidebar overflow | [[frontend-gotchas]] | InputText v2 nao repassa maxlength, SWC nao recarrega decorators, sync manual do core, chatfunnel-database nao existe, dialog aninhado modal=false invisivel, vue-i18n d() sem datetimeFormats retorna vazio, overflow-y aninhado empurra icones do rail em ≤900px |
