...
|--------|--------|-----------|
| [[wiki/features/_index\|Features]] | `wiki/features/_index.md` | Documentacao end-to-end de cada feature do produto |
...
| [[raw/]] | Staging area — conteudo bruto pra ser processado em wiki |
